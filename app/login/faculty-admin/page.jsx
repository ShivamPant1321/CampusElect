        ...
        >
          ...
          <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-900/80 rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
            <div className="px-4 pt-6 pb-6">
              ...
              >
                <motion.div 
                  className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-tr from-blue-600 to-indigo-600 shadow-xl mb-4"
                  whileHover={{ scale: 1.05, rotate: 5 }}
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <motion.button
                    type="submit"
                    disabled={loading}
                    className={`w-full flex justify-center py-3 px-3 border border-transparent rounded-2xl text-sm font-medium text-white shadow-lg ${
                      loading 
